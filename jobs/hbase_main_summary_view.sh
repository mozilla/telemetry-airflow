...
reservations=$(aws ec2 describe-instances --filters "Name=tag:Name,Values=telemetry-hbase" "Name=tag:aws:elasticmapreduce:instance-group-role,Values=MASTER" | jq -r '.Reservations')
