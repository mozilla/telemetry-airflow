...
Occasionally, the app can fail if it cannot understand the nimbus experiment configuration properly, but most
of these cases should have coverage by now.  Other issues that may occur is if the sample size is too low which
may cause some problems during the statistical analysis.  I'm still looking for more examples of these situations
to fix.
