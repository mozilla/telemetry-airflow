# Ported from https://github.com/fivetran/airflow-provider-fivetran/blob/main/tests/operators/test_operators.py
"""
Unittest module to test Fivetran Operators.
Requires the unittest, pytest, and requests-mock Python libraries.
Run test:
    python3 -m unittest operators.backport.fivetran.tests.test_operators.TestFivetranOperator
"""
