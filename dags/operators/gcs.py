...
# MOZILLA NOTE: This was pulled directly from, with some changes for Airflow 1.10.2 & py2.7
# https://github.com/apache/airflow/blob/a87f3dfc0c513b05271cba7051c18e4e742ef245/airflow/gcp/operators/gcs.py#L321
...
class GoogleCloudStorageDeleteOperator(BaseOperator):
    ...
    template_fields = BaseOperator.template_fields + ['bucket_name', 'prefix', 'objects']
