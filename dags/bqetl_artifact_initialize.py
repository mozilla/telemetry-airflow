...
with DAG(
    ...
    GKEPodOperator(
        ...
        arguments=[
            generate_sql_cmd_template
            + "script/bqetl query initialize '*' --project-id=moz-fx-data-shared-prod --project-id=moz-fx-data-experiments --project-id=moz-fx-data-marketing-prod --project-id=moz-fx-data-bq-people"
        ],
        image=docker_image,
