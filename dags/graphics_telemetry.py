...
with DAG(
    ...
    graphics_trends = SubDagOperator(
        ...
        subdag=moz_dataproc_pyspark_runner(
            ...
            python_driver_code="https://raw.githubusercontent.com/mozilla/python_mozetl/benwu/graphics/mozetl/graphics/graphics_telemetry_trends.py",
    ...
    graphics_dashboard = SubDagOperator(
        ...
        subdag=moz_dataproc_pyspark_runner(
            ...
            python_driver_code="https://raw.githubusercontent.com/mozilla/python_mozetl/benwu/graphics/mozetl/graphics/graphics_telemetry_dashboard.py",
            init_actions_uris=["gs://dataproc-initialization-actions/python/pip-install.sh"],
            additional_metadata={'PIP_PACKAGES': " ".join(PIP_PACKAGES)},
            additional_properties={"spark:spark.jars": "gs://spark-lib/bigquery/spark-bigquery-latest_2.12.jar",
                                   "spark-env:AWS_ACCESS_KEY_ID": aws_access_key,
