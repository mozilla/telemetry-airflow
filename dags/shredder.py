...
flat_rate_main_summary = gke_command(
    ...
    + [
        ...
        "--parallelism=10",
        "--billing-projects",
        "moz-fx-data-backfill-1",
        "moz-fx-data-backfill-2",
        "moz-fx-data-backfill-3",
        "moz-fx-data-backfill-4",
        "moz-fx-data-backfill-5",
        "moz-fx-data-backfill-6",
        "moz-fx-data-backfill-7",
        "moz-fx-data-backfill-8",
        "moz-fx-data-backfill-9",
