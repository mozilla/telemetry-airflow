...
clients_scalar_aggregates = bigquery_etl_query(
    ...
    arguments=("--replace", "--reservation_id=moz-fx-bigquery-reserv-global:US.glam"),
    dag=dag,
)
...
clients_histogram_probe_counts = bigquery_etl_query(
    ...
    project_id=billing_project_id,
    date_partition_parameter=None,
    arguments=("--replace", "--clustering_fields=metric,channel", "--reservation_id=moz-fx-bigquery-reserv-global:US.glam"),
    dag=dag,
)
