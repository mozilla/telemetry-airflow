...
dag = DAG(
    "taar_daily_gcs", default_args=default_args, schedule_interval="0 4 * * *"
)
...
amodump = GKEPodOperator(
    ...
    image="gcr.io/moz-fx-data-airflow-prod-88e0/taar_gcp_etl:0.5.3",
    owner="vng@mozilla.com",
...
taar_similarity = SubDagOperator(
    ...
    subdag=moz_dataproc_pyspark_runner(
        ...
        python_driver_code="gs://temp-hwoo-removemelater/taar_similarity.py",
...
#              "--privateBucket=gs://" + TAAR_ETL_MODEL_STORAGE_BUCKET,
#            ],
...
editorial_whitelist >> taar_locale
